...
|-------|------------|------|
| [LivsLoops](GitHub Repo URL) | Designed and built a crochet-inspired e-commerce website promoting body positivity and creativity | React, CSS, Figma |
| [Verdata](GitHub Repo URL) | Built a sustainability-focused web app to help users understand and reduce their carbon footprint | React, Node.js, APIs |
| [Kinnect](GitHub Repo URL) | Designed a community-focused app to promote cultural belonging through shared experiences | UX Design, Prototyping |
...
🌐 portfolio: [livias-website.onrender.com/](https://livias-website.onrender.com/)
